...
CREATE VIEW [dbo].[uv_AverageRevperItem_SDD]
AS
...
,(SELECT        bb.Name
	  ...
	  1 AS Number, e.KeyFeatured, d.ProductCode,e.Description AS ProductDec, a.ProfitCentreCode AS ProfitCenterCode, b.StateId , st.Name as State, d.SerializedValueAddedServices, d.SerializedSurcharges
...
d.ItemValue,d.Id,br.StateId,a.CreatedOn,b.StateId, a.NetValue,d.ChargeTotal,st.Name, e.ParentProductCode, d.SerializedValueAddedServices, d.SerializedSurcharges

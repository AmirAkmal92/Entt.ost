...
[Environment]::SetEnvironmentVariable("RX_OST_SdsApi_GenerateConnoteEst", "apigateway/as01/api/generateconnotebaby/v1", "Machine")
[Environment]::SetEnvironmentVariable("RX_OST_SdsSecretKey_GenerateConnoteEst", "NjloNDVKSUtiRm05MGdHR1dtbkdpQ09NOVpSN3hObWU=", "Machine")
[Environment]::SetEnvironmentVariable("RX_OST_SdsApi_PickupWebApi", "apigateway/as2poslaju/api/ezisendpickupwebapi/v1", "Machine")
[Environment]::SetEnvironmentVariable("RX_OST_SdsSecretKey_PickupWebApi", "ckk1cjZ4V2NwSHJWVFZCTVVsSmZGSWtESUpBanNra0g=", "Machine")

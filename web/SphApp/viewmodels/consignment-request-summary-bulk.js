...
objectbuilders.app, '/assets/pages/scripts/ui-sweetalert'],
...
function (context, logger, router, system, validation, eximp, dialog, watcher, config, app, partial) {
    ...
    var entity = ko.observable(new bespoke.Ost_consigmentRequest.domain.ConsigmentRequest(system.guid())),
        ...
        activate = function(entityId) {
            ...
            context.loadOneAsync("EntityForm", "Route eq 'consignment-request-summary-bulk'")
                .then(function(f) {
                form(f);
                ...
                .then(function(w) {
                watching(w);
                return $.getJSON("i18n/" + config.lang + "/consignment-request-summary-bulk");
            })
                .then(function(n) {
                i18n = n[0];
        ...
        attached = function(view) {
            // validation
            validation.init($('#consignment-request-summary-bulk-form'), form());

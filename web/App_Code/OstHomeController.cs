    ...
    ""filter"": {{
      ""query"": {{
        ...
        private static string GetLabelConnoteZplCode(ConsigmentRequest item, Consignment itemHasConnote)
        {
            ...
            zplCode += "^FT27,784^AQ^FH^FD" + itemHasConnote.Penerima.Address.State.ToUpper() + "^FS";
            zplCode += "^FT27,812^AQ^FH^FD" + itemHasConnote.Penerima.Address.Postcode + "^FS";
            ...
            zplCode += "^FT540,916^AU,48,124^FH^FD" + itemHasConnote.Penerima.Address.Postcode + "^FS";
            zplCode += "^FT28,845^AQ^FH^FDTEL : " + itemHasConnote.Penerima.ContactInformation.ContactNumber + "^FS";
            zplCode += "^FT26,878^AQ^FH^FDPOSKOD : ^FS";
            zplCode += "^FT254,844^AQ^FH^FDTEL2 : " + itemHasConnote.Penerima.ContactInformation.AlternativeContactNumber + "^FS";
